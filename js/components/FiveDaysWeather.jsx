                ...
                <section className="section-5daysweather">
                    <div className="container">
                        ...
                        <div className="dayinfo">
                            ...
                            <div className="temperature">{this.state.meteoData.list[8].main.temp}<sup>o</sup>C</div>
                        ...
                        <div className="dayinfo">
                            ...
                            <div className="temperature">{this.state.meteoData.list[16].main.temp}<sup>o</sup>C</div>
                        ...
                        <div className="dayinfo">
                            ...
                            <div className="temperature">{this.state.meteoData.list[24].main.temp}<sup>o</sup>C</div>
                        </div>
                        <div className="dayinfo">
                            ...
                            <div className="temperature">{this.state.meteoData.list[32].main.temp}<sup>o</sup>C</div>
                        </div>
                    </div>
                </section>
            )
